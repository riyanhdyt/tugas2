...
<body>
	<!--header-->
				...
				<div class="container">
					<div class="logo-nav">
						<div class="logo-nav-left">
							<h1><a href="{{ url("/home") }}">New Shop <span>Shop anywhere</span></a></h1>
						</div>
											...
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu1</h6>
														<li><a href="{{ url("/produk") }}">Clothing</a></li>
														<li><a href="{{ url("/produk") }}">Wallets</a></li>
														<li><a href="{{ url("/produk") }}">Shoes</a></li>
														<li><a href="{{ url("/produk") }}">Watches</a></li>
														<li><a href="{{ url("/produk") }}"> Underwear </a></li>
														<li><a href="{{ url("/produk") }}">Accessories</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu2</h6>
														<li><a href="{{ url("/produk") }}">Sunglasses</a></li>
														<li><a href="{{ url("/produk") }}">Wallets,Bags</a></li>
														<li><a href="{{ url("/produk") }}">Footwear</a></li>
														<li><a href="{{ url("/produk") }}">Watches</a></li>
														<li><a href="{{ url("/produk") }}">Accessories</a></li>
														<li><a href="{{ url("/produk") }}">Jewellery</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
														<a href="{{ url("/produk") }}"><img src="images/woo.jpg" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="{{ url("/produk") }}"><img src="images/woo1.jpg" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu1</h6>
														<li><a href="{{ url("/produk1") }}">Clothing</a></li>
														<li><a href="{{ url("/produk1") }}">Wallets</a></li>
														<li><a href="{{ url("/produk1") }}">Shoes</a></li>
														<li><a href="{{ url("/produk1") }}">Watches</a></li>
														<li><a href="{{ url("/produk1") }}"> Underwear </a></li>
														<li><a href="{{ url("/produk1") }}">Accessories</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu2</h6>
														<li><a href="{{ url("/produk1") }}">Sunglasses</a></li>
														<li><a href="{{ url("/produk1") }}">Wallets,Bags</a></li>
														<li><a href="{{ url("/produk1") }}">Footwear</a></li>
														<li><a href="{{ url("/produk1") }}">Watches</a></li>
														<li><a href="{{ url("/produk1") }}">Accessories</a></li>
														<li><a href="{{ url("/produk1") }}">Jewellery</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
														<a href="{{ url("/produk1") }}"><img src="images/woo4.jpg" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="{{ url("/produk1") }}"><img src="images/woo3.jpg" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="{{ url("/home") }}"">Home</a> / <span>Products</span></h3>
			</div>
		</div>
	<!--banner-->
		<!--content-->
										...
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
											<ul>
												<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
													<ul>
														<li><a href="{{ url("/produk") }}"">Shirts</a></li>
														<li><a href="{{ url("/produk") }}"">Caps</a></li>
														<li><a href="{{ url("/produk") }}"">Shoes</a></li>
														<li><a href="{{ url("/produk") }}"">Pants</a></li>
														<li><a href="{{ url("/produk") }}"">SunGlasses</a></li>
														<li><a href="{{ url("/produk") }}"">Trousers</a></li>
													</ul>
												</li>
							...
							<div class="footer-grids">
								...
								<div class="col-md-3 footer-grid">
									...
									<ul>
										...
										<li><a href="codes.html">Short Codes</a></li>
										<li><a href="mail.html">Mail Us</a></li>
										<li><a href="{{ url("/produk1") }}"">products1</a></li>
									</ul>
								</div>
